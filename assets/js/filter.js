...
var pul = false;
function deleteAll(){
  var pullar = document.querySelectorAll(".thumb");
...
async function opentkv() {
  ...
  for (var i = 0; i < takvimler.length; i++) {
    takvimler[i].style.display = "block";
  }
  var hedef = document.getElementById("baslik");
